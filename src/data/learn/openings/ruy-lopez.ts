...
The lesson: the Exchange Variation is a model of simplicity. By trading pieces and pushing pawns, White can grind out an endgame advantage. The variation is not flashy, but it's effective.`,
    },
    {
      ...
      content: `Wait, the Marshall Attack doesn't end with Boden's Mate. Let me restart with a more accurate line.

The Marshall Attack is the most aggressive reply to the Closed Spanish. Frank Marshall unveiled it against Capablanca in 1918, and it has been a top-level weapon ever since.
...
We'll explore the Marshall in more detail in the next section.`,
    },
    {
      ...
      type: "position",
      interactionMode: "guided",
      fen: "r1bq1rk1/2ppbppp/p1n2n2/1p2p3/4P3/1BP2N2/PP1P1PPP/RNBQR1K1 w - - 0 8",
