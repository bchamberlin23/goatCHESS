...
In this position, the d-file is completely open. White has a rook on d1 and another on d3 — both rooks on the open file. The Black rook on d8 is matched. The key question: which side can break through?`,
    },
    {
      ...
      moveDescriptions: [
        "Rd7! White plays the rook to the 7th rank, attacking the b7 pawn and establishing total control of the back rank.",
        "Black is forced to defend passively with Rb8. The rook on b8 is doing nothing — it's not on an open file.",
        "R1d2! White doubles down, preparing to bring the second rook to the 7th rank. Black is completely paralyzed.",
        "Black plays Rxb2, grabbing a pawn. The position is now lost for Black.",
        "Rxb2! White trades rooks, simplifying into a winning endgame. The rook on b2 is active.",
        "Rxb2, recapturing. The endgame is now sharp.",
        "Rxb2, winning the rook. Wait, the rook is already on b2. Let me restart this with a simpler example.",
      ],
