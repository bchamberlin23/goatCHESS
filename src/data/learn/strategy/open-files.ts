...
3. Overprotecting the entry points: Ensure the entry squares on the open file are protected so your rooks can safely slide forward.`,
    },
    {
      ...
      moves: ["Rd7", "Rb8", "R1d2"],
      moveDescriptions: [
        "White plays Rd7, establishing a rook on the 7th rank, attacking the b7 pawn.",
        "Black is forced to defend passively with ...Rb8.",
        "White doubles down, preparing to bring the second rook to the 7th rank. Black is completely paralyzed."
      ],
...
- Acts as a shield, blocking enemy lines of communication.`,
    },
    {
      ...
      orientation: "white",
      quizFen: "r1bqk2r/pp2ppbp/2np1np1/8/3NP3/2N1B3/PPP1BPPP/R2QK2R w KQkq - 4 8",
      quizAnswer: ["Nd5"],
      quizHint: "Look for a central square where your knight can jump, supported by a pawn, and cannot be easily attacked by Black's pawns.",
